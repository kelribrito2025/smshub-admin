...
export default function HeroSection({ onCreateAccount }: { onCreateAccount?: () => void }) {
  ...
  return (
    <div className="min-h-[85vh] bg-black text-white relative">
      {/* Animated Background */}
      ...
      <section className="relative flex items-center justify-center px-4 pt-20 pb-16">
        <div className="max-w-7xl mx-auto text-center">
          ...
          {/* Main Heading - Hidden since it's already in the page title */}
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed mt-8">
