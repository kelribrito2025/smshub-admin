    ...
    <DashboardLayoutWrapper>
      <div className="p-8 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button onClick={() => setAddDialogOpen(true)} className="bg-green-600 hover:bg-green-700" style={{backgroundColor: '#1447e5'}}>
      ...
      {refundModal.show && refundModal.transaction && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="font-sans bg-neutral-900 border border-neutral-800 rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl">
