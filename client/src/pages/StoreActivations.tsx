          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-2">
            ...
            <div className="relative w-full md:w-48">
              ...
              <Input
                ...
                className="pl-10 bg-black/50 border-green-900/50 text-green-400 placeholder:text-green-600/50 focus:border-green-500 focus-visible:ring-0 focus-visible:ring-offset-0 font-mono"
              />
            </div>
          </div>
