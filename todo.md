...
## 🐛 Remover Modal Verde Duplicado Após Recarga PIX

**Problema:**
- Após confirmação de recarga via PIX, aparecem dois modais em sequência
- Modal verde: "Recarga Aprovada! Sua recarga de R$ X foi confirmada!"
- Modal azul: "Saldo Atualizado - Novo saldo: R$ X"
- Apenas o toast azul deve ser mantido

**Tarefas:**
- [x] Localizar onde o modal verde é exibido no código
- [x] Remover exibição do modal verde de confirmação
- [x] Manter apenas o toast azul de saldo atualizado
- [x] Testar fluxo completo de recarga PIX

---

## 🎨 Alterar Cor do Toast "Saldo Atualizado" para Verde

**Objetivo:**
- Mudar a cor do toast "Saldo Atualizado" de azul para verde padrão do sistema
- Manter consistência visual com o restante da aplicação

**Tarefas:**
- [x] Alterar toast.info para toast.success no tipo balance_updated
- [x] Testar visualmente a alteração
