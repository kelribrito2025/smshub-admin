...
## 🔄 Mover Controles de Afiliados para Página Correta

**Problema:**
- Toggle de ativar/desativar programa de afiliados e campo de percentual de bônus foram movidos para a página de Relatórios
- Esses controles não têm relação com a página de Relatórios
- Devem estar na página de Afiliados, no canto superior direito

**Objetivo:**
- Mover toggle e campo de percentual de volta para a página de Afiliados
- Posicionar no canto superior direito da página (área destacada na imagem)
- Remover da página de Relatórios

**Tarefas:**
- [x] Mover toggle de ativar/desativar programa de afiliados para o canto superior direito da página de Afiliados
- [x] Mover campo de percentual de bônus para o canto superior direito da página de Afiliados
- [x] Remover controles da página de Relatórios
- [x] Testar funcionalidade dos controles na nova posição
