...
## 🔗 Corrigir Redirecionamento do Botão "Fazer Login"

**Problema:**
- Botão "Fazer Login" na página de ativação de conta redireciona para `https://app.numero-virtual.com/store/login` (página inexistente)
- Deveria redirecionar para `https://app.numero-virtual.com`
- Botão não abre em nova aba

**Tarefas:**
- [x] Localizar componente do botão "Fazer Login" na página de ativação
- [x] Corrigir URL de redirecionamento para `https://app.numero-virtual.com`
- [x] Adicionar `target="_blank"` e `rel="noopener noreferrer"` para abrir em nova aba
