...
## 🎨 Substituir Loader Centralizado por Skeletons Específicos

**Objetivo:**
- Remover loader centralizado "Carregando…" da navegação interna
- Criar skeletons específicos para cada página
- Aproveitar cache + staleTime + SSE para transições instantâneas
- Melhorar percepção de performance e profissionalismo

**Tarefas:**
- [x] Criar componente DashboardSkeleton
- [x] Criar componente ServicesListSkeleton
- [x] Criar componente ActivationsTableSkeleton
- [x] Criar componente HistorySkeleton
- [x] Criar componente AffiliatesSkeleton (já existia AffiliateSkeleton)
- [x] Criar componente ProfileSkeleton
- [x] Criar componente RechargeHistorySkeleton (usando HistorySkeleton)
- [x] Criar componente SettingsSkeleton (usando GenericPageSkeleton)
- [x] Criar componente SecuritySkeleton (usando GenericPageSkeleton)
- [x] Remover loader centralizado da navegação interna
- [x] Integrar skeletons em cada página com isLoading
- [x] Testar transições entre todas as páginas
- [x] Validar que cache evita exibição de skeleton em navegações subsequentes
